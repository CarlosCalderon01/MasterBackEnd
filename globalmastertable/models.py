...
class Gmtcountry(models.Model):
    ...
    phone = models.CharField(max_length=6, blank=True, null=True)
    num = models.CharField(max_length=6, blank=True, null=True)
...
class Gmtstate(models.Model):
    id = models.SmallIntegerField(primary_key=True)
    gmtcountryid = models.ForeignKey(
        Gmtcountry, models.DO_NOTHING, db_column='gmtcountryid')
    name = models.TextField()
...
class Gmtcity(models.Model):
    id = models.SmallIntegerField(primary_key=True)
    gmtstateid = models.ForeignKey(
        'Gmtstate', models.DO_NOTHING, db_column='gmtstateid')
    name = models.TextField()
...
class Gmtneighborhood(models.Model):
    id = models.SmallIntegerField(primary_key=True)
    gmtcityid = models.ForeignKey(
        Gmtcity, models.DO_NOTHING, db_column='gmtcityid')
    name = models.TextField()
